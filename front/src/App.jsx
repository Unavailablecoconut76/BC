      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-white">GoLand</span>
          </div>
          ...
          <button
            ...
            className="hidden md:flex items-center space-x-2 bg-emerald-500 hover:bg-emerald-600 text-white px-6 py-2 rounded-lg transition-all"
          >
          ...
          <div className="md:hidden py-4 space-y-2">
            {navItems.map(item => (
              <button
                ...
                className="flex items-center space-x-2 w-full px-3 py-2 text-slate-300 hover:text-emerald-400 hover:bg-slate-800 rounded-lg"
              >
                <item.icon className="w-4 h-4" />
                <span>{item.label}</span>
              </button>
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        <div className="mb-8 inline-flex items-center space-x-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full px-4 py-2">
        ...
        <p className="text-xl text-slate-300 mb-12 max-w-3xl mx-auto">
          Revolutionary blockchain platform for transparent, fraud-proof land registration and property transfers. 
          verification, smart contracts, and seamless government integration.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            onClick={() => scrollToSection('login')}
            className="bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all flex items-center justify-center space-x-2"
          >
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">GoLand</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-400 text-sm">
              ...
              <li><a href="#" className="hover:text-emerald-400">API Documentation</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-400 text-sm">
              ...
              <li><a href="#" className="hover:text-emerald-400">Legal Compliance</a></li>
