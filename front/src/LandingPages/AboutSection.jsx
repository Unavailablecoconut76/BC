      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About <span className="text-emerald-400">GoLand</span>
          </h2>
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            Transforming land registry with blockchain technology to eliminate fraud, reduce complexity, and ensure transparent property transactions.
          </p>
        </div>

        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-slate-900 border border-red-500/20 rounded-xl p-8">
              ...
              <div key={idx} className="relative">
                ...
                {idx < 3 && (
                  <div className="hidden md:block absolute top-1/2 -right-3 transform -translate-y-1/2">
                    <ChevronDown className="w-6 h-6 text-emerald-400 rotate-[-90deg]" />
                  </div>
                )}
              </div>
            ))}
